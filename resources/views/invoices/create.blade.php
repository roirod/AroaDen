                  ...
                  <td class="wid60 textcent">{!! @trans("aroaden.date") !!}</td>                  
                    ...
                    @if (!in_array($item->idtre, $invoiceLines))
                        ...
                        <td class="wid60 textcent">{!! date ('d-m-Y', strtotime ($item->day) ) !!}</td>                      
          						  	...
          						  	<button class="btn btn-sm btn-info addLine" data-idtre="{!! $item->idtre !!}" data-name="{!! $item->service_name !!}" data-units="{!! $item->units !!}" data-day="{!! date('d-m-Y', strtotime($item->day)) !!}">
